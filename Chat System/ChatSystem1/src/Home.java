...
public class Home extends JFrame {
	...
	private static JLabel connection=new JLabel();;
		...
		submitbutton.addActionListener(new ActionListener()
				{
					...
					else
					{
						JOptionPane.showMessageDialog(frame,"VALID USER LOGIN");
						 frame.setTitle("CHAT SYSTEM                                                                  WELCOME   "+cheak.getName().toUpperCase());
						//ServerChat();
						try {
							allClear();
	...
	public void ForgetPassword()
	{
	 ...
	 void InitilizeServer(int port) throws IOException
		{
		 server=new ServerSocket(port);
			//messagePrint.setText("WAITING FOR CLIENT..............\n");
			Socket socket=server.accept();
			//messagePrint.setText("");
			connection.setText("CONNECTED WITH FRIEND");
